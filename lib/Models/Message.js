...
class Message extends Helper_1.default {
    ...
    async send(req, res, type) {
        ...
        try {
            if (this.session) {
                ...
                if (type == 10) {
                    optionObj = {
                        ephemeralExpiration: req.body.expiration ? req.body.expiration : baileys_1.WA_DEFAULT_EPHEMERAL
                    };
                }
                ...
                messageKeyData.key['id'] = await (0, baileys_1.generateMessageID)();
                let msgObj = {
                    ...messageKeyData,
                    ...messageData,
                    pending: true,
    ...
    async sendReply(req, res) {
        ...
        if (req.body.messageType == 10) {
            let newObj = {
                ephemeralExpiration: req.body.messageData.expiration ? req.body.messageData.expiration * 1000 : baileys_1.WA_DEFAULT_EPHEMERAL
            };
            quotedObj = {
                ...quotedObj,
                ...newObj
        ...
        try {
            if (req.body.messageType == 17) {
                ...
                let thumb = await (0, baileys_1.generateThumbnail)(responseFile.data, 'image', {});
    ...
    async sendOneFromGroup(phone, input, res, loop, checked) {
        ...
        if (input.messageType == 10) {
            newObj = {
                ephemeralExpiration: input.messageData.expiration ? input.messageData.expiration * 1000 : baileys_1.WA_DEFAULT_EPHEMERAL
            };
        }
        try {
